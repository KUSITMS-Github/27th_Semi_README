...
|분야|이름|포지션|
|------|---|---|
|박형준|기획|프로젝트 매니징, 서비스 기획, 기능 설계, 리서치 분석|
|김다연|기획|서비스 기획, 기능 설계, 유저 플로우|
|박세은|기획|서비스 기획, 기능 설계, 유저 플로우|
...
> 응답자의 약 71%가 '동아리 및 대외활동을 위해 지원서를 작성해본 경험이 있다'고 응답했으며, 이들중 약 54%가 '지원서 작성시 불편함을 느꼈다'라고 답했습니다.


> 또한 '동아리 및 대외활동을 위해 지원서를 작성해본 경험이 있다'고 응답한 사람들 중 약 71%가 pc, 노트북, 아이패드, 탭 등에 지원서를 보관하고 있다고 응답했으며, 메모장, 구글드라이브, 노션 순으로 해당 장소에 보관하고 있습니다.

> 아래의 문항들에대한 척도는 1~5로 설정했으며 1 : 매우 그렇지 않다, 5 : 매우 그렇다 입니다. 해당 문항에대한 답변 척도로 4 이상으로 선택할 경우 동의하는 것으로 설정하였습니다.
...
<img width="912" alt="스크린샷 2023-04-16 오후 2 28 09" src="https://user-images.githubusercontent.com/113091000/232272975-8e226a0d-2651-41b4-960f-52735365051c.png">

> 위의 문항들에대한 척도 답변을 통하여 응답자들이 어려움을 겪는 지점은 3가지로 볼 수 있습니다.<br>
> <br>1. 지원서를 빠르게 찾아보기 어렵다.
> <br>2. 지원서를 한 눈에 모아보기 어렵다.
> <br>3. 과거 지원서에 작성했던 유사문항을 확인하기 어렵다.

따라서 

<!--워너플라이는 지원서를 하나의 사이트에서 저장·보관하고 하나의 창에서 여러 개의 지원서를 볼 수 있도록 하여 지원서 작성수정 시 발생할 수 있는 사용자의 여러 불편함을 해소하는 것을 목적으로 합니다.-->

>워너플라이는 지원서를 하나의 사이트에서 관리하고, 지원서를 작성할 때 발생할 수 있는 사용자의 불편함을 해소시켜주는 서비스입니다.

|타겟|문제점|기대효과|
|------|---|---|
|동아리 및 대외활동을 지원하기위해 지원서를 작성하려는 대학생들|작성했던 지원서를 한 눈에 모아보기 힘들며 빠르게 찾아보기 어려운 경우|작성했던 지원서들이 한 곳에 모여있는 경험을 통해 편리함을 느낄 수 있음|
